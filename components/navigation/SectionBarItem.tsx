...
export const SectionBarItem = ({ currentSection, onClick, section }: Props) => {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      ></div>
      <div
        className={`flex items-center gap-2 cursor-pointer hover:opacity-100 hover:scale-110 transition-all ease-in ${
          currentSection === section.id ? "opacity-100 scale-110" : "opacity-40"
        }`}
